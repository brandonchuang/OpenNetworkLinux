...
#define DECLARE_QSFP28_TRANSCEIVER_ATTR(index)  &sensor_dev_attr_module_present_##index.dev_attr.attr, \
             ...
             char *buf)
{
    ...
    u8  size[] = {0, ARRAY_SIZE(regs_cpld2), ARRAY_SIZE(regs_cpld3), ARRAY_SIZE(regs_cpld3)};
    u8 bus[] = {0, 12, 13, 76};
